...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['StoragePidMigrationWizard'] = \Schnitzler\Templavoila\Update\StorageFolderMigrationWizard::class;
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['DataStructureDataprotMigrationWizard'] = \Schnitzler\Templavoila\Update\DataStructureDataprotMigrationWizard::class;
